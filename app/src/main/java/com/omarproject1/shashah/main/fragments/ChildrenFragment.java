...
public class ChildrenFragment extends Fragment {
    ...
    private FirebaseRecyclerOptions<VideoItem> childrenRecyclerOptions;
    private FirebaseRecyclerAdapter<VideoItem, VideoHolder> childrenRecyclerAdapter;
    ProgressBar childrenProgressBar;
    ...
    private void initiation() {
        childrenProgressBar = view.findViewById(R.id.progress_circle_children);
        childrenRecyclerView = view.findViewById(R.id.children_recyclerView);
        childrenRecyclerView.setHasFixedSize(true);
        childrenRecyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));
    ...
    public void onStart() {
        super.onStart();
        Query query = childrenReference.orderByKey();

        childrenRecyclerOptions = new FirebaseRecyclerOptions.Builder<VideoItem>()
                .setQuery(query, VideoItem.class)
                .build();
        childrenRecyclerAdapter = new FirebaseRecyclerAdapter<VideoItem, VideoHolder>(childrenRecyclerOptions) {
            @Override
        ...
        childrenRecyclerAdapter.startListening();
        childrenRecyclerView.setAdapter(childrenRecyclerAdapter);
...
//        deleteDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Query query = childrenReference.orderByChild("videoTitle").equalTo(videoTitle);
