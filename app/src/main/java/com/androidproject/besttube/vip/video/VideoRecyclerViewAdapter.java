...
public class VideoRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    DatabaseReference mono3atReference, sportsReference, childrenReference, religiousReference, educationReference, likeReference;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        String thumb = videoItemList.get(position).getThumbnail();
        try {
    ...
    public void removeVideoData() {
        switch (deleteCategory) {
            ...
            case "ديني":
                ...
                break;
            case "تعليمي":
                Query games = educationReference.orderByChild("videoUrl").equalTo(url);
