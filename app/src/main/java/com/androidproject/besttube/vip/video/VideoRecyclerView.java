...
public class VideoRecyclerView extends RecyclerView implements PlaybackPreparer {
    ...
    private ImageView thumbnail, volumeControl, playBtn, downloadBtn;
    private MKLoader progressBar;
    private View viewHolderParent;
    private FrameLayout frameLayout;
    public PlayerView playerView;
    public SimpleExoPlayer videoPlayer;
    public CircleImageView ownerImage;
    ...
    private void playVideo(boolean isEndOfList) {
        ...
        ownerImage.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if(targetPosition == 0){
                    ...
                    videoItem = videoItemList.get(targetPosition);
                }
                Intent intent = new Intent(context, ProfileActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("UserUid", videoItem.getVideoOwner());
        ...
        downloadBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    context.startActivity(intent);
//                    Toast.makeText(context, "" + videoItem.getVideoTitle(), Toast.LENGTH_SHORT).show();
