package com.androidproject.besttube.vip.intro;
...
import com.androidproject.besttube.vip.model.IntroScreenItem;
...
//        getSupportActionBar().hide();
        ...
        myIntroList.add(new IntroScreenItem(getResources().getString(R.string.education_intro_title), getResources().getString(R.string.education_intro_description), R.drawable.ic_intro_education));
        ...
        myIntroList.add(new IntroScreenItem(getResources().getString(R.string.sports_intro_title), getResources().getString(R.string.sports_intro_description), R.drawable.ic_intro_sports));
